 ...
 */
	...
	public:
		 ...
		 */
		explicit line_iterator(cv::Size          boundaries, cv::Point p1, cv::Point p2, int connectivity);
		 ...
		 * The line is 8-connected or 4-connected.
		 */
		explicit line_iterator(cv::Rect          boundaries, cv::Point p1, cv::Point p2, int connectivity);
		 ...
		 * The line is 8-connected or 4-connected.
		 */
		explicit line_iterator(no_boundaries_tag boundaries, cv::Point p1, cv::Point p2, int connectivity);
